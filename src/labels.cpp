...
//	labels["other"               ] = LabelInfo("other"               , "void"         ,  35, 0, QColor(128,128,128));
	...
	// Customized labels for fluvial scene labeling
	labels["river"                ] = LabelInfo("river"                , "flat"         ,  07, 1, QColor(128, 64,128));
	labels["forest vegetation"    ] = LabelInfo("forest vegetation"    , "nature"       ,  21, 4, QColor(107,142, 35));
	labels["senescent vegetation" ] = LabelInfo("senescent vegetation" , "nature"       ,  22, 4, QColor(250,170,30));
	labels["dry sediment"         ] = LabelInfo("dry sediment"         , "object"       ,  20, 3, QColor(220,220,  0));
	labels["sky"                  ] = LabelInfo("sky"                  , "sky"          ,  23, 5, QColor( 70,130,180));
	labels["wood in river"        ] = LabelInfo("wood in river"        , "vehicle"      ,  31, 7, QColor(  150,120, 90));
	labels["boat"                 ] = LabelInfo("boat"                 , "construction" ,  11, 2, QColor( 0, 0, 230));
	labels["bridge"               ] = LabelInfo("bridge"               , "vehicle"      ,  33, 7, QColor(119, 11, 32));
	labels["self"                 ] = LabelInfo("self"                 , "void"         ,  04, 0, QColor( 10,  0,  0));
